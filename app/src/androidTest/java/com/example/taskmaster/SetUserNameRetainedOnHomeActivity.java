...
public class SetUserNameRetainedOnHomeActivity {
    ...
    @Test
    public void setUserNameRetainedOnHomeActivity() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.homeTasksListTitleTextVIew), withText("Jon"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Jon")));
    }
